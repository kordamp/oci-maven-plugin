 ...
 */
@CompileStatic
class InternetGatewayPrinter {
    static void printInternetGateway(ValuePrinter printer, InternetGateway internetGateway, int offset) {
        printer.printKeyValue('ID', internetGateway.id, offset + 1)
        printer.printKeyValue('Compartment ID', internetGateway.compartmentId, offset + 1)
