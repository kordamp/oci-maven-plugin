 ...
 */
@CompileStatic
trait CompartmentDescriptionAwareTrait implements PathAware {
    ...
    String getCompartmentDescription() {
        stringProperty('OCI_COMPARTMENT_DESCRIPTION', 'oci.compartment.description', this.@compartmentDescription)
    }
