 ...
 */
@CompileStatic
class EgressSecurityRulePrinter {
    static void printEgressSecurityRule(ValuePrinter printer, EgressSecurityRule rule, int offset) {
        printer.printKeyValue('Destination', rule.destination, offset + 1)
        printer.printKeyValue('Destination Type', rule.destinationType, offset + 1)
