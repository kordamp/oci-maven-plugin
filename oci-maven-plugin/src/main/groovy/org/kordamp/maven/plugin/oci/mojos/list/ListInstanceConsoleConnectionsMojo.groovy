...
import org.kordamp.maven.plugin.oci.mojos.printers.InstanceConsoleConnectionPrinter
...
class ListInstanceConsoleConnectionsMojo extends AbstractOCIMojo implements CompartmentIdAwareTrait, InstanceIdAwareTrait {
    ...
    protected void executeGoal() {
        ...
        for (InstanceConsoleConnection connection : response.items) {
            ...
            InstanceConsoleConnectionPrinter.printInstanceConsoleConnection(this, connection, 0)
            index++
        }
    }
}
