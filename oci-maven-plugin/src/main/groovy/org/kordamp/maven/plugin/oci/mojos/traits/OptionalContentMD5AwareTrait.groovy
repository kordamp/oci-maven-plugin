 ...
 */
@CompileStatic
trait OptionalContentMD5AwareTrait implements PathAware, ExecutionIdAware, LogAware {
    @Parameter(property = 'oci.content.md5', name = 'contentMD5')
    String contentMD5

    String getContentMD5() {
        stringProperty(this, 'OCI_CONTENT_ENCODING', 'oci.content.md5', this.@contentMD5)
    }
}
