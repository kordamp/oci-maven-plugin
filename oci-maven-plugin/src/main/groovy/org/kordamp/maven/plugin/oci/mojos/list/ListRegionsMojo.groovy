...
import org.kordamp.maven.plugin.oci.mojos.printers.RegionPrinter
 ...
 */
@CompileStatic
@Mojo(name = 'list-regions')
class ListRegionsMojo extends AbstractOCIMojo implements VerboseAwareTrait {
    @Override
    protected void executeGoal() {
        ...
        for (Region region : response.items) {
            ...
            if (isVerbose()) {
                RegionPrinter.printRegion(this, region, 0)
            }
        }
    }
}
