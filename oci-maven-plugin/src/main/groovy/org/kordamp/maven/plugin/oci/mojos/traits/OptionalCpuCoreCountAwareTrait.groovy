 ...
 */
@CompileStatic
trait OptionalCpuCoreCountAwareTrait implements PathAware, ExecutionIdAware, LogAware {
    @Parameter(property = 'oci.cpu.core.count', name = 'cpuCoreCount')
    Integer cpuCoreCount

    Integer getCpuCoreCount() {
        integerProperty(this, 'OCI_CPU_CORE_COUNT', 'oci.cpu.core.count', this.@cpuCoreCount)
    }
}
