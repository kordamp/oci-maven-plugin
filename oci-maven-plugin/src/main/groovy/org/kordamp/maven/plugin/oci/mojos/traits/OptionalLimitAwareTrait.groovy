 ...
 */
@CompileStatic
trait OptionalLimitAwareTrait implements PathAware, ExecutionIdAware, LogAware {
    @Parameter(property = 'oci.limit', name = 'limit')
    Integer limit

    Integer getLimit() {
        integerProperty(this, 'OCI_LIMIT', 'oci.limit', this.@limit)
    }
}
