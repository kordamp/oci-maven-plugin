...
import org.kordamp.maven.plugin.oci.mojos.printers.AvailabilityDomainPrinter
 ...
 */
@CompileStatic
@Mojo(name = 'list-availability-domains')
class ListAvailabilityDomainsMojo extends AbstractOCIMojo implements CompartmentIdAwareTrait, VerboseAwareTrait {
    @Override
    ...
    protected void executeGoal() {
        ...
        for (AvailabilityDomain domain : response.items) {
            ...
            if (isVerbose()) {
                AvailabilityDomainPrinter.printAvailabilityDomain(this, domain, 0)
            }
        }
    }
}
