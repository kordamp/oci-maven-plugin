 ...
 */
@CompileStatic
trait OptionalStartAwareTrait implements PathAware, ExecutionIdAware, LogAware {
    @Parameter(property = 'oci.start', name = 'start')
    String start

    String getStart() {
        stringProperty(this, 'OCI_START', 'oci.start', this.@start)
    }
}
