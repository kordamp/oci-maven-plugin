 ...
 */
@CompileStatic
trait OptionalContentLanguageAwareTrait implements PathAware, ExecutionIdAware, LogAware {
    @Parameter(property = 'oci.content.language', name = 'contentLanguage')
    String contentLanguage

    String getContentLanguage() {
        stringProperty(this, 'OCI_CONTENT_LANGUAGE', 'oci.content.language', this.@contentLanguage)
    }
}
