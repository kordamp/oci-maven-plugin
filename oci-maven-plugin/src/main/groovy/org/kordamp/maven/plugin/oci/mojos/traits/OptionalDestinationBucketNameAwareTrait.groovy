 ...
 */
@CompileStatic
trait OptionalDestinationBucketNameAwareTrait implements PathAware, LogAware {
    @Parameter(property = 'oci.destination.bucket.name', name = 'destinationBucketName')
    String destinationBucketName

    String getDestinationBucketName() {
        stringProperty('OCI_DESTINATION_BUCKET_NAME', 'oci.destination.bucket.name', this.@destinationBucketName)
    }
}
