 ...
 */
@CompileStatic
trait OptionalPrefixAwareTrait implements PathAware, ExecutionIdAware, LogAware {
    @Parameter(property = 'oci.prefix', name = 'prefix')
    String prefix

    String getPrefix() {
        stringProperty(this, 'OCI_PREFIX', 'oci.prefix', this.@prefix)
    }
}
