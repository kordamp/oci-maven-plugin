...
import static org.kordamp.maven.PropertyUtils.integerProperty
 ...
 */
@CompileStatic
trait OptionalDataStorageSizeAwareTrait implements PathAware, ExecutionIdAware, LogAware {
    @Parameter(property = 'oci.data.storage.size', name = 'dataStorageSize')
    Integer dataStorageSize

    Integer getDataStorageSize() {
        integerProperty(this, 'OCI_DATA_STORAGE_SIZE', 'oci.data.storage.size', this.@dataStorageSize)
    }
}
