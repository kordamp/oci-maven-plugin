...
import org.kordamp.maven.plugin.oci.mojos.traits.DestinationDirAwareTrait
 ...
 */
@CompileStatic
@Mojo(name = 'download-object')
class DownloadObjectMojo extends AbstractOCIMojo implements NamespaceNameAwareTrait,
    ...
    protected void executeGoal() {
        ...
        File destination = new File(getDestinationDir(), getObjectName())
