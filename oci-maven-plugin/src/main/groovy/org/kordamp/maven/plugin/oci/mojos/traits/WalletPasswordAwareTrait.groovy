 ...
 */
@CompileStatic
trait WalletPasswordAwareTrait implements PathAware, ExecutionIdAware, LogAware {
    @Parameter(property = 'oci.wallet.password', name = 'walletPassword')
    String walletPassword

    String getWalletPassword() {
        stringProperty(this, 'OCI_WALLET_PASSWORD', 'oci.wallet.password', this.@walletPassword)
    }

    void validateWalletPassword() {
        if (isBlank(getWalletPassword())) {
